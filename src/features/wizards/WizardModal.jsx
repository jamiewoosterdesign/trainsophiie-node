            ...
            {showSaveConfirm && (
                <div className="absolute inset-0 z-[60] flex items-center justify-center bg-black/20">
                    <div className="bg-white p-6 rounded-xl shadow-2xl w-80 animate-in zoom-in-95">
                        ...
                        <p className="text-sm text-slate-500 mb-6">Are you sure you want to leave? Your progress will be lost.</p>
                ...
                <div className="w-full md:w-[55%] flex flex-col border-r border-slate-200 bg-white relative z-10">
                    ...
                    <div className="px-8 py-6 border-b border-slate-100 flex justify-between items-center bg-white">
                        <div className="flex items-center gap-3">
                            {(step > 1 || returnToMode) && (
                                <button onClick={handleBack} className="p-1.5 hover:bg-slate-100 rounded-full transition-colors text-slate-400 hover:text-slate-700">
